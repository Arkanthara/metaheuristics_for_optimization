...
![cities.dat problem of 30 cities for the greedy algorithm](./images/cities_greedy.png){#fig-cities_greedy fig-pos="H"}
![cities.dat problem of 30 cities for the simulated annealing algorithm](./images/cities_sa.png){#fig-cities_sa fig-pos="H"}
![cities.dat problem of 30 cities for the parallel tempering algorithm](./images/cities_pt.png){#fig-cities_pt fig-pos="H"}

## Cities2 problem

![cities.dat problem of 30 cities for the greedy algorithm](./images/cities_greedy.png){#fig-bench_greedy fig-pos="H"}
![cities.dat problem of 30 cities for the simulated annealing algorithm](./images/cities_sa.png){#fig-bench_sa fig-pos="H"}
![cities.dat problem of 30 cities for the parallel tempering algorithm](./images/cities_pt.png){#fig-bench_pt fig-pos="H"}
...
However, we can constate that on the $10$ executions, the simulated annealing and parallel tempering algorithms don't find always the optimal result
because the best fitness mean exeeds that of the greedy best fitness mean, as illustrated in @fig-bench_sa and @fig-bench_pt.
