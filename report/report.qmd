...
The algorithm can be represented by the @fig-diagram in annexe [-@sec-annexe].

### Algorithm variantes

There is a lot of different variants of the simulated annealing algorithm, such as parallel tempering, 
