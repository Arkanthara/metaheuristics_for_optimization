...
For the $20$ cities random problem, the algorithm that perform the best average performance is the parallel tempering with an average best fitness $10\%$ better than average fitness of both other methods.
However, the simulated annealing found the best result.
